 ...
 */
final class Version20230916122755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE books (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, publisher_id INT NOT NULL, creator_id INT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, availability INT NOT NULL, INDEX IDX_4A1B2A924296D31F (genre_id), INDEX IDX_4A1B2A9240C86FCE (publisher_id), INDEX IDX_4A1B2A9261220EA6 (creator_id), INDEX IDX_4A1B2A92F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE genres (id INT AUTO_INCREMENT NOT NULL, genre_title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX uq_genres_genreTitle (genre_title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publishers (id INT AUTO_INCREMENT NOT NULL, publisher_title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX uq_publishers_publisherTitle (publisher_title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
